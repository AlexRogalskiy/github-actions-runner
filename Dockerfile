...
RUN curl -O https://githubassets.azureedge.net/runners/2.160.0/actions-runner-linux-x64-2.160.2.tar.gz && tar xzf ./actions-runner-linux-x64-2.160.0.tar.gz && rm ./actions-runner-linux-x64-2.160.0.tar.gz && ./bin/installdependencies.sh
